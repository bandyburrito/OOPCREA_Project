...
new CardClass("Last Stand", 2, "Gain block equal to your missing health."),
...
new CardClass("Heroic Strike", 2, "Deal 10 damage."),
new CardClass("Rally", 3, "Restore 6 health to all allies."),
new CardClass("Shield Wall", 2, "Gain 15 block but skip your next attack."),
new CardClass("Whirlwind", 3, "Deal damage equal to your block to all enemies."),
new CardClass("Second Wind", 2, "Restore 5 health and gain 3 block."),
new CardClass("Crushing Blow", 2, "Deal 12 damage and reduce target's armor by 5."),
...
new CardClass("Guardian's Oath", 2, "Take all damage for allies this turn and gain 8 block."),
...
new CardClass("Shockwave", 2, "Deal 6 damage to all enemies and stun them for 1 turn."),
new CardClass("Indomitable", 2, "Become immune to damage for 1 turn."),
...
new CardClass("Valiant Charge", 2, "Deal 9 damage and heal for half the damage dealt.")
    };
